export default {
    ...
    config: {
        ...
        customChannelDisabled: "Custom channels are disabled by the administrator, please contact your administrator",
        ...
        channels: {
            ...
            modeRemote: "Backend channels",
            modeRemoteDescription: "AI requests are proxied through this site's backend; channels are configured by the administrator and billed in credits.",
            modeLocal: "Local channels",
            modeLocalDescription: "The browser calls your own API endpoints and keys directly; requests bypass the backend.",
            modeRemoteUnavailable: "The backend does not expose channel proxying yet. Contact the administrator or use local channels.",
            add: "Add provider",
