...
function LoginContent() {
    ...
    useEffect(() => {
        ...
        void fetchCurrentUser(tokenParam)
            .then((user) => {
                ...
                navigate(resolveLoginRedirect(redirect, user.role), { replace: true });
    ...
    }, [clearSession, message, navigate, redirect, searchParams, setSession]);
    ...
    }, [hydrateUser, navigate, redirect, searchParams, token, user]);
