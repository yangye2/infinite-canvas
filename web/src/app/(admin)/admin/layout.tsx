...
import { AuditOutlined, FileImageOutlined, FileTextOutlined, HomeOutlined, LogoutOutlined, PictureOutlined, SettingOutlined, ToolOutlined, TransactionOutlined, UserOutlined, AppstoreOutlined } from "@ant-design/icons";
...
const adminMenus = [
    ...
    { key: "/admin/banners", icon: <FileImageOutlined />, label: "Banner 管理" },
    { key: "/admin/workflows", icon: <AppstoreOutlined />, label: "工作流模板" },
                ...
                : pathname.startsWith("/admin/workflows")
                  ...
                  : pathname.startsWith("/admin/credit-logs")
                    ...
                    : pathname.startsWith("/admin/users")
                      ? "/admin/users"
                      : "";
    const pageTitle = pathname.startsWith("/admin/settings") ? "系统设置" : pathname.startsWith("/admin/assets") ? "素材库管理" : pathname.startsWith("/admin/skills") ? "Skill 管理" : pathname.startsWith("/admin/prompts") ? "提示词管理" : pathname.startsWith("/admin/banners") ? "Banner 管理" : pathname.startsWith("/admin/workflows") ? "工作流模板" : pathname.startsWith("/admin/ai-logs") ? "AI 日志" : pathname.startsWith("/admin/credit-logs") ? "算力点日志" : "用户管理";
